...
* Added support for using string-type coordinate columns in sexagesimal and degree formats for catalog overlays ([#2954](https://github.com/CARTAvis/carta-frontend/issues/2954)).
### Fixed
