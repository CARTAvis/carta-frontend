...
* Fixed channel switching via spectral profiler click not working for images with no `SPECSYS` header ([#2688](https://github.com/CARTAvis/carta-frontend/issues/2688)).
### Changed
