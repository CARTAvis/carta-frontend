...
* Fixed workspaces failing to load images from a non-zeroth HDU with "does not exist". Workspaces saved with previous versions have to be saved again ([#2934](https://github.com/CARTAvis/carta-frontend/issues/2934)).
