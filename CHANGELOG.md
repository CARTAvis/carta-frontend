...
* Fixed incorrect flux density values in the spectral profiler after changing the intensity unit ([#2878](https://github.com/CARTAvis/carta-frontend/issues/2878)).
