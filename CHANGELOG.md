...
* Fixed workspaces failing to load images from a non-zeroth HDU with "does not exist", including workspaces saved with previous versions ([#2934](https://github.com/CARTAvis/carta-frontend/issues/2934)).
