    ...
    public render() {
        ...
        return (
            <div className={className}>
                ...
                {alertComponent}
                <TaskProgressDialogComponent progress={appStore.taskProgress} timeRemaining={0} isOpen={appStore.genericTaskProgressVisible} cancellable={false} text={appStore.genericTaskText} />
