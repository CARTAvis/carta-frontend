            ...
            <div onKeyDown={this.onKeyDown} tabIndex={0}>
                ...
                >
                    <Layer>
                        ...
                        <CursorRegionComponent frame={frame} region={frame.regionSet?.cursorRegion} layerWidth={this.props.width} layerHeight={this.props.height} stageRef={this.stageRef} />
                        {creatingLine}
                    </Layer>
                </Stage>
            </div>
