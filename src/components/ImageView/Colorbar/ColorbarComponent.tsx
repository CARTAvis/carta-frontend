...
export class ColorbarComponent extends React.Component<ColorbarComponentProps> {
    ...
    render() {
        ...
        } else if (colorbarSettings.position === "top" && overlaySettings.title.isShow) {
                    ...
                    if (colorbarSettings.position !== "right") {
                        ...
                        switch (colorbarSettings.numberRotation) {
                            ...
                            case 0:
                                ...
                                break;
                            case -90:
                                numberYPos = positions[i] + colorbarSettingsHeight / 2;
                                break;
                            default:
                                break;
                        }
        ...
        if (colorbarSettings.position === "right") {
            ...
            switch (colorbarSettings.labelRotation) {
                case 90:
                    ...
                    break;
                case -90:
                    labelYPos += colorbarSettingsHeight;
                    break;
                default:
                    break;
            }
