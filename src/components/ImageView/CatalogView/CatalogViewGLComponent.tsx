...
export class CatalogViewGLComponent extends React.Component<CatalogViewGLComponentProps> {
    ...
    render() {
        ...
        catalogStore.catalogGLData.forEach((catalog, fileId) => {
            ...
            const isShowSelectedData = catalogWidgetStore.isShowSelectedData;
            ...
            const isSizeArea = catalogWidgetStore.isSizeArea;
            ...
            const isSizeMinorArea = catalogWidgetStore.isSizeMinorArea;
            ...
            const isInvertedColorMap = catalogWidgetStore.isInvertedColorMap;
        ...
        const className = classNames("catalog-div", {isDocked: this.props.isDocked, active: appStore.activeLayer === ImageViewLayer.Catalog});
    ...
    private renderCatalog() {
        ...
        catalogStore.visibleCatalogFiles.get(destinationFrame)?.forEach(fileId => {
            ...
            if (catalog && catalogWidgetStore && count && count > 0) {
                ...
                this.gl.uniform1i(shaderUniforms.ShowSelectedSource, catalogWidgetStore.isShowSelectedData ? 1.0 : 0.0);
                // frameView
                ...
                this.gl.uniform1i(shaderUniforms.AreaMode, catalogWidgetStore.isSizeArea ? 1 : 0);
                ...
                if (!catalogWidgetStore.shouldDisableSizeMap && sizeTexture) {
                ...
                if (!catalogWidgetStore.shouldDisableColorMap && colorTexture) {
                ...
                if (!catalogWidgetStore.shouldDisableOrientationMap && orientationTexture) {
                ...
                this.gl.uniform1i(shaderUniforms.AreaModeMinor, catalogWidgetStore.isSizeMinorArea ? 1 : 0);
                const sizeMinorTexture = this.catalogWebGLService.getDataTexture(fileId, CatalogTextureType.SizeMinor);
                if (!catalogWidgetStore.shouldDisableSizeMinorMap && sizeMinorTexture && catalogWidgetStore.catalogShape === CatalogOverlayShape.ELLIPSE_LINED) {
