...
export class VectorOverlayViewComponent extends React.Component<VectorOverlayViewComponentProps> {
    ...
    private resizeAndClearCanvas() {
        ...
        this.vectorOverlayWebGLService.setCanvasSize(requiredWidth * appStore.imageViewConfigStore.numImageColumns, requiredHeight * appStore.imageViewConfigStore.numImageRows);
    ...
    render() {
        ...
        if (overlayFrames) {
            for (const frame of overlayFrames) {
                ...
                const {angularSource, intensitySource, thickness, rotationOffset, color, colormapBias, colormapContrast, colormapEnabled, colormap, lengthMin, lengthMax, visible} = config;
