            ...
            if (frame) {
                return (
                    <Menu>
                        ...
                        <MenuDivider />
                        <MenuItem disabled={frame.frameInfo?.fileInfoExtended?.depth <= 1} text="Set rest frequency" onClick={() => appStore.dialogStore.showRestFreqDialog(frame.frameInfo.fileId)} />
                        <MenuDivider />
