...
export class TelemetryDialogComponent extends React.Component {
    @observable isAllowUsageStats: boolean = true;
    ...
    optInClicked = async () => {
        await TelemetryService.Instance.optIn(this.isAllowUsageStats ? TelemetryMode.Usage : TelemetryMode.Minimal);
    };
                ...
                <div className={Classes.DIALOG_BODY}>
                    <div className="image-div">
                        ...
                        <div className="button-grid">
                            ...
                            <Button intent={Intent.PRIMARY} onClick={this.optOutClicked} data-testid="telemetry-opt-out-button">
