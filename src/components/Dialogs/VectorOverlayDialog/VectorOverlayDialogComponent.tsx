        ...
        const configPanel = (
            <div className="vector-overlay-config-panel">
                ...
                <FormGroup inline={true} label="Debiasing">
                    <Switch checked={this.isDebiasing} onChange={this.handleDebiasingChanged} data-testid="vector-field-isDebiasing-toggle" />
                </FormGroup>
                ...
                {dataSource.vectorOverlayConfig.isColormapEnabled ? (
                    <React.Fragment>
                        <FormGroup inline={true} label="Colormap">
                            <ColormapComponent isInverted={false} selectedColormap={dataSource.vectorOverlayConfig.colormap} onColormapSelect={dataSource.vectorOverlayConfig.setColormap} />
                        </FormGroup>
