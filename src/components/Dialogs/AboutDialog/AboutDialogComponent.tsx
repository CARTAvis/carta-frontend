        ...
        return (
            ...
            >
                <div className={Classes.DIALOG_BODY}>
                    ...
                    <Button variant="minimal" icon="database" endIcon={this.extendExternalServices ? "double-chevron-up" : "double-chevron-down"} alignText={"right"} size="small" onClick={this.toggleExtendExternalServices}>
