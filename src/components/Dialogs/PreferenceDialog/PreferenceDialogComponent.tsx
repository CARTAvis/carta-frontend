        ...
        const renderConfigPanel = (
            <React.Fragment>
                <FormGroup inline={true} label="Default Scaling">
                    <ScalingComponent selectedItem={preference.scaling} onItemSelect={(selected) => preference.setPreference(PreferenceKeys.RENDER_CONFIG_SCALING, selected)}/>
                </FormGroup>
        ...
        const wcsOverlayPanel = (
            <React.Fragment>
                ...
                <FormGroup inline={true} label="WCS Format">
                    <RadioGroup selectedValue={preference.wcsType} onChange={(ev) => preference.setPreference(PreferenceKeys.WCS_OVERLAY_WCS_TYPE, ev.currentTarget.value)}>
