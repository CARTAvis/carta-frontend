            ...
            <div className="line-settings-panel">
                <React.Fragment>
                    ...
                    {typeof props.shouldShowWCSAxis !== "undefined" && props.handleWcsAxisChanged && (
                        <FormGroup disabled={props.isDisableShowWCSAxis} inline={true} label={"Show WCS axis"}>
                            <Switch disabled={props.isDisableShowWCSAxis} checked={props.shouldShowWCSAxis} onChange={props.handleWcsAxisChanged} />
                        </FormGroup>
                    )}
