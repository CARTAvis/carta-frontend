...
export class ScatterPlotComponent extends React.Component<ScatterPlotComponentProps> {
    ...
    onStageWheel = ev => {
        if (this.props.data && this.props.isScrollZoom && this.props.graphZoomedXY && this.chartArea && this.props.xMin !== undefined && this.props.xMax !== undefined && this.props.yMin !== undefined && this.props.yMax !== undefined) {
