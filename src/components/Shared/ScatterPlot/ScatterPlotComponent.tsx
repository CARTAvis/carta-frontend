...
export class ScatterPlotComponent extends React.Component<ScatterPlotComponentProps> {
    ...
    exportImage = () => {
        ...
        ctx.fillStyle = AppStore.Instance.preferenceStore.global.transparentImageBackground ? "rgba(255, 255, 255, 0.0)" : this.props.darkMode ? Colors.DARK_GRAY3 : Colors.LIGHT_GRAY5;
