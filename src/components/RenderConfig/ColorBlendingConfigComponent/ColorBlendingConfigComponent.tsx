        ...
        <MenuItem
            ...
            icon={
                colormapSetConfig.type === "gradient" ? (
                    <ColormapBlock colormap={colormapSetConfig.colormap} isInverted={colormapSetConfig.isInverted} />
                ) : (
                    <div className="colormap-set-blocks">
                        {colormapSetConfig.colormaps.map(x => (
                            <ColormapBlock colormap={x} isInverted={false} isRoundIcon={true} key={x} />
                        ))}
                    </div>
                )
            }
