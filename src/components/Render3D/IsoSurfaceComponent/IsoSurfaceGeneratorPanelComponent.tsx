...
import "./IsoSurfaceGeneratorPanelComponent.scss";

const GeneratorSelect = Select<ContourGeneratorType>;

@observer
export class IsoSurfaceGeneratorPanelComponent extends React.Component<{
    frame: FrameStore;
    ...
    @computed get minValue() {
        if (this.enteredMinValue === undefined && this.props.frame && this.props.frame.renderConfig.isoSurfaceHistogram) {
            return getPercentiles(this.props.frame.renderConfig.isoSurfaceHistogram, [0.1])[0];
        } else {
    ...
    @computed get maxValue() {
        if (this.enteredMaxValue === undefined && this.props.frame && this.props.frame.renderConfig.isoSurfaceHistogram) {
            return getPercentiles(this.props.frame.renderConfig.isoSurfaceHistogram, [99.9])[0];
        } else {
    ...
    @computed get startValue() {
        if (this.enteredStartValue === undefined && this.props.frame && this.props.frame.renderConfig.isoSurfaceHistogram && this.props.frame.renderConfig.isoSurfaceHistogram.stdDev > 0) {
            return this.props.frame.renderConfig.isoSurfaceHistogram.mean + 5.0 * this.props.frame.renderConfig.isoSurfaceHistogram.stdDev;
        } else {
    ...
    @computed get stepValue() {
        if (this.enteredStepValue === undefined && this.props.frame && this.props.frame.renderConfig.isoSurfaceHistogram && this.props.frame.renderConfig.isoSurfaceHistogram.stdDev > 0) {
            return 4.0 * this.props.frame.renderConfig.isoSurfaceHistogram.stdDev;
        } else {
    ...
    @computed get refValue() {
        if (this.enteredRefValue === undefined && this.props.frame && this.props.frame.renderConfig.isoSurfaceHistogram) {
            return getPercentiles(this.props.frame.renderConfig.isoSurfaceHistogram, [99.9])[0];
        } else {
    ...
    @computed get meanValue() {
        if (this.enteredMeanValue === undefined && this.props.frame && this.props.frame.renderConfig.isoSurfaceHistogram && this.props.frame.renderConfig.isoSurfaceHistogram.stdDev > 0) {
            return this.props.frame.renderConfig.isoSurfaceHistogram.mean;
        } else {
    ...
    @computed get sigmaValue() {
        if (this.enteredSigmaValue === undefined && this.props.frame && this.props.frame.renderConfig.isoSurfaceHistogram && this.props.frame.renderConfig.isoSurfaceHistogram.stdDev > 0) {
            return this.props.frame.renderConfig.isoSurfaceHistogram.stdDev;
        } else {
    ...
    render() {
        ...
        return (
            <div className="isosurface-generator-panel">
