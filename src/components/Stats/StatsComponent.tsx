                ...
                <div className={className}>
                    <div className="stats-toolbar">
                        ...
                        <FormGroup label={"Polarization"} inline={true} disabled={!isEnableStokesSelect}>
                            <HTMLSelect className={stokesClassName} value={widgetStore.coordinate} options={coordinateOptions} onChange={this.handleCoordinateChanged} disabled={!isEnableStokesSelect} data-testid="polarization-dropdown" />
                        </FormGroup>
                    </div>
