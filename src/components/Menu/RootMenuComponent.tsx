...
import {BrowserMode, ConnectionStatus, DialogId, ImageType, PreferenceKeys, WorkspaceDialogMode} from "enums";
...
import {AppStore, SnippetStore, WidgetsStore, WidgetType} from "stores";
