...
export const HISTOGRAM_HELP_CONTENT = (
    <div>
        ...
        <p>
            The Histogram Widget displays a histogram plot based on the selections in the <b>Image</b>, <b>Region</b>, and <b>Polarization</b> dropdown menus. When no region is selected, the entire image is used to compute the histogram.
        </p>
        <p>
        ...
        <p>
            The <b>Region</b> dropdown menu defaults to "Active", which means the currently selected region. You can select a region by clicking on one in the Image Viewer, or by clicking on a region entry in the Region List Widget. The
            histogram plot of the selected region will be updated accordingly. When no region is selected, the entire image is used to compute the histogram.
        </p>
        ...
        <p>
            In addition, the plotting x and y ranges can be set explicitly in the <b>Styling</b> tab of the Histogram Settings Dialog.
        </p>
