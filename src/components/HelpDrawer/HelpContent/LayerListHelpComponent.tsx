...
export class LayerListHelpComponent extends React.Component {
    public render() {
        return (
            <div>
                <p>The layer list widget displays loaded images as a list, which includes image name, rendering type (R as raster and C as contours) and layer visibility state, WCS matching state, channel index, and Stokes index. The channel index and Stokes index are synchronized with the animator.</p>
