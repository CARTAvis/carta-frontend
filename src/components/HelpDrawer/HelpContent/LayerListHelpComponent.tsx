    ...
    public render() {
        return (
            <div>
                ...
                <p>You may click <code>R</code> and/or <code>C</code> to hide/show a layer. For example, if you want to generate an image with contours only, you can hide raster layers by clicking <code>R</code>.</p>
