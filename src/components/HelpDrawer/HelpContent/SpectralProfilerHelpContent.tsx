...
export const SPECTRAL_PROFILER_HELP_CONTENT = (
    <div>
        ...
        <p>
            ...
            <code>Image</code> dropdown) with a specific statistic (via the <code>Statistic</code> dropdown; default as mean). If Stokes axis exists, you may view a specific Stokes via the <code>Stokes</code> dropdown. You may have multiple
        ...
        <ul>
            <li>
                When the <code>Image</code> checkbox is selected: spectra from <em>different spatially and spectrally matched images</em>, from the selected region with the selected statistic, and the selected Stokes (if applicable), are
                displayed.
            </li>
            <li>
        ...
        <p>
            When the image checkbox is selected and if there are spatially and spectrally matched images (apply matching via the image list widget), the dropdown menu will display an image list with information about the matching state. You
        ...
        <p>
            The displayed profile can be smoothed via the <code>Smoothing</code> tab of the spectral profiler settings dialog (the cog icon). A shortcut button of the <code>Smoothing</code> tab can be found at the top-right corner of the
            widget.
        </p>
        ...
        <p>
            You can fit a profile to a spectrum in the view via the <code>Fitting</code> tab of the spectral profiler settings dialog (the cog icon). You can find a shortcut button to the <code>Fitting</code> tab at the top-right corner of
