    ...
    public render() {
        return (
            <div>
                <h3>Marker size</h3>
                <p>
                    This dialog provides options to set the size of source markers of an image overlay. If the <code>Column</code> dropdown menu is None, all
                    markers are rendered with a uniform size as set with the <code>Size</code> dropdown menu. You may assign a numeric data column for size
                    mapping. Different scaling, size mode, size range, or clip bounds can be applied.
                </p>
                <p>
