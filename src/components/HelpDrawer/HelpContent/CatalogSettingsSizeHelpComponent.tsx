...
export class CatalogSettingsSizeHelpComponent extends React.Component {
    public render() {
        return (
            <div>
                <h3>Marker size</h3>
                <p>This dialogue provides options to define the size of source markers of an image overlay. If the &quot;Column&quot; dropdown menu is None, all markers are rendered with a uniform size as defined with the &quot;Size&quot; dropdown menu. Users may assign a numeric data column for size mapping. Different scaling, size mode, size range, or clip bounds can be applied.</p>
