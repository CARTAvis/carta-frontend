...
export const CATALOG_OVERLAY_HELP_CONTENT = (
    <div>
        ...
        <p>
            ...
            closure of the selected catalog file from the <b>File</b> dropdown. Additionally, in scenarios involving spatially matched images, the sharing of catalog image overlays is executed among these matched images, all while adhering
            to appropriate coordinate transformations.
        </p>
    </div>
);
