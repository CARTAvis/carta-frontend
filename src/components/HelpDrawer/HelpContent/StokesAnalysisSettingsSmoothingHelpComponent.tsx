...
export class StokesAnalysisSettingsSmoothingHelpComponent extends React.Component {
    public render() {
        return (
            <div>
                <h3>Smoothing</h3>
                <p>Smoothing may be applied to profiles and the scatter plot to enhance signal-to-noise 
                ...
                <p>The data of the smoothed profile is appended in the exported 
                    tsv file if smoothing is applied. The tsv file of the scatter plot only 
                    contains the smoothed data if smoothing is applied.</p>
