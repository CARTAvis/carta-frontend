    ...
    public render() {
        return (
            <div>
                ...
                <p>As an option in the &quot;Styling&quot; tab of the spatial profiler settings dialogue, mean and RMS values of the profile can be visualized as a green dashed line and a shaded area in the profile plot. Numerical values
                ...
                <p>The displayed profile can be smoothed via the &quot;Smoothing&quot; tab of the spatial profiler settings dialogue (the cog icon).</p>
