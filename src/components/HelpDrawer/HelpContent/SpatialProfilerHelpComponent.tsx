    ...
    public render() {
        return (
            <div>
                ...
                <p>Spatial profiler widget allows you to view a profile from a horizontal cut or a vertical cut at the cursor position in the image viewer. The cursor position may be fixed in the image viewer by
                ...
                <p>When cursor is in the image viewer, the cursor position and pointed pixel value in image and world coordinates are reported at the bottom-left corner of the spatial profiler widget. When cursor moves into the spatial
                    profile plot, numerical values of the profile at the cursor position (displayed as a grey vertical line) will be reported instead.</p>
                <h3 id="profile-mean-and-rms">Profile mean and RMS</h3>
                <p>As an option in the &quot;Styling&quot; tab of the spatial profiler settings dialog, mean and RMS values of the profile can be visualized as a green dashed line and a shaded area in the profile plot. Numerical values
                ...
                <p>The displayed profile can be smoothed via the &quot;Smoothing&quot; tab of the spatial profiler settings dialog (the cog icon).</p>
                ...
                <p>The appearance of the spatial profile plot is customizable via the &quot;Styling&quot; tab of the spatial profiler settings dialog (the cog icon). Supported options are:</p>
                <ul>
                ...
                <br/>
                <h4 id="note">NOTE</h4>
                <p>For performance reasons, a profile is min-max decimated before rendering if the number of points of the profile is greater than the screen resolution of the spatial profiler widget. The kernel size of profile decimation is
