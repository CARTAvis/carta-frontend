    ...
    public render() {
        return (
            <div>
                ...
                <p>As an option in the <code>Styling</code> tab of the spatial profiler settings dialog, mean and RMS values of the profile can be visualized as a green dashed line and a shaded area in the profile plot. Numerical values
                ...
                <p>The displayed profile can be smoothed via the <code>Smoothing</code> tab of the spatial profiler settings dialog (the cog icon).</p>
                ...
                <p>The appearance of the spatial profile plot is customizable via the <code>Styling</code> tab of the spatial profiler settings dialog (the cog icon). Supported options are:</p>
                <ul>
