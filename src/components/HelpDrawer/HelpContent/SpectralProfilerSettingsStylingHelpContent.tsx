export const SPECTRAL_PROFILER_SETTINGS_STYLING_HELP_CONTENT = (
    <div>
        ...
        <p>
            As an option in the Spectral Profiler Settings Dialog, mean and RMS values of the profile can be visualized as a green dashed line and a shaded area in the profile plot. Numeric values are displayed at the bottom-left corner.
