    ...
    public render() {
        return (
            <div>
                ...
                <p>File header dialogue provides full image header and a summary of the properties of the image in the current image view. To switch to other images, use the image slider in the animator widget, or use the image list widget.</p>
            </div>
        );
    }
}
