    ...
    public render() {
        return (
            <div>
                ...
                <p>The animator widget controls which image, which channel (if exists per image file), and which Stokes (if exists per image file) to view in the image viewer. Users may also enable animation playback for image, channel, or Stokes, via the &quot;Play&quot; button. The radio buttons control which one to animate. Playback mode includes</p>
                <ul>
                ...
                <p>For performance concern and resource management, animation playback will be automatically stopped after 5 minutes by default. This can be customized in the &quot;Performance&quot; tab of the preferences dialogue (<strong>File</strong> -&gt; <strong>Preferences</strong>). Maximum playback time is 30 mins.</p>
            </div>
        );
    }
}
