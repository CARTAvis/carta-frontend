...
export const IMAGE_FITTING_HELP_CONTENT = (
    <div>
        ...
        <p>
            You can use the <code>Components</code> spinbox to define the number of Gaussian components in the fit. For each component, you need to define a set of initial guess to describe a 2D Gaussan including <code>Center</code>,{" "}
            <code>Amplitude</code>, <code>FWHM</code>, and <code>P.A. (deg)</code> (position angle). In the current implementation, center and FWHM are defined in pixel. In a future release, these two parameters can also be defined in
            angular unit.
        </p>
        <p>
            ...
            <code>Full Log</code> tab, more information of the fitting results is provided, includling the best-fit solution in the image coordinate.
        </p>
    </div>
);
