...
export const STOKES_ANALYSIS_HELP_CONTENT = (
    <div>
        ...
        <p>
            The Stokes analysis widget is specifically made for efficient visualization of a cube with <em>multiple channels and multiple Stokes parameters (at least QU)</em>. If you have Stokes images as individual files, please use the
        ...
        <p>
            ...
            Stokes profile plot of the selected region will be updated accordingly. If no region is selected, &quot;Active&quot; region defaults to cursor.
        </p>
        ...
        <p>
            ...
            experience. In addition, if you move a region while profiles are being updating, the old calculations will be terminated immediately and calculations of the new region Stokes profiles will start. You will see partial profiles in
            seconds.
        </p>
