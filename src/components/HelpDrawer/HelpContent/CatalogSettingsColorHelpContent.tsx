...
export const CATALOG_SETTINGS_COLOR_HELP_CONTENT = (
    <div>
        <h3>Marker color</h3>
        <p>
            This dialog provides options to set a color or a colormap to source markers of an image overlay. The shape of the marker can be set with the <code>Shape</code> dropdown menu. If the <code>Column</code> dropdown menu is None, all markers are rendered with a single color as set with the <code>Color</code>{" "}
