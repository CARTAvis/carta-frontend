...
export class FileBrowserHelpComponent extends React.Component {
    public render() {
        return (
            <div>
                ...
                <ul>
                    ...
                    <li>Unix-style search (e.g., *.fits) with the syntax +&lt;expression&gt; (e.g., +*.fits)</li>
                    <li>Regular expression search (e.g., colou?r) with the syntax /&lt;expression&gt;/ (e.g., /colou?r/)</li>
                </ul>
        ...
        image with <strong>Load image</strong>. Image shown in the image viewer can be closed via <strong>File</strong>
                    -&gt; <strong>Close image</strong>. Images can be saved in CASA or FITS format via <strong>File</strong>
                    -&gt; <strong>Save image</strong>.</p>
        ...
        side needs to provide write permission (not a problem for the Desktop release).</p>
                ...
                When a catalog file is selected, its basic catalog properties are summarized in the &quot;Catalog Information&quot; tab
        on the right-hand side. Full catalog column header is shown in the &quot;Catalog Header&quot; tab.</p>
            </div>
        );
    }
}
