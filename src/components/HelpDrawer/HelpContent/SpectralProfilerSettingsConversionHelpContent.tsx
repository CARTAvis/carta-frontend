export const SPECTRAL_PROFILER_SETTINGS_CONVERSION_HELP_CONTENT = (
    <div>
        ...
        <br />
        <h4>NOTE</h4>
        Intensity unit conversion currently works only with a <em>single</em> spectral profile. Support for the multi-profile mode will be implemented in a future release.
    </div>
);
