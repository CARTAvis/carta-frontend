...
export const FILE_INFO_HELP_CONTENT = (
    <div>
        ...
        <p>
            The file header dialog provides a full image header (<code>Header</code> tab) and a summary of the properties of the active image (<code>File Information</code> tab). To view the file headers of other images, use the image slider in
        ...
        <h4>NOTE</h4>
        The origin of the image coordinates in FITS definition is 1-based, meaning that the origin at the center of the bottom-left corner pixel is (1, 1). In CARTA, the origin of the image coordinates is 0-based so that the origin at the center of the
