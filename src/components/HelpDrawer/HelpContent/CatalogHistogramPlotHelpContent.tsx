export const CATALOG_HISTOGRAM_PLOT_HELP_CONTENT = (
    <div>
        ...
        <p>
            ...
            (after filtering). The <code>Plot</code> button will request a full download of all entries and the histogram plot will then include all entries (after filtering). The number of bins and the scale of the y-axis (linear or log)
            can be customized.
        </p>
        <p>
