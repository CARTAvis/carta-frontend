...
export const REGION_LIST_HELP_CONTENT = (
    <div>
        ...
        <p>
            ...
            all spatially matched images. Shared regions are approximated as polygon regions, so on the spatially matched images we may see region distortion as a result of projection. However, the region sky coverages on the reference and
