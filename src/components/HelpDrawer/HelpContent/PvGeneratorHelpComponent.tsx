...
export const PV_GENERATOR_HELP_CONTENT = (
    <div>
        ...
        <p>
            When a PV image is being computed, a progress bar will show up to let you know the progress of the PV image generation. The generation process may be canceled by clicking the <code>Cancel</code> button. Once the generation
