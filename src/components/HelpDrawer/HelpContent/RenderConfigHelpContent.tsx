...
export const RENDER_CONFIG_HELP_CONTENT = (
    <div>
        ...
        <p>
            ...
            <code>Clip Max</code> fields. If these fields are edited manually, the clip level will be switched to <code>Custom</code>. The clip boundaries are visualized as two vertical lines (draggable) in red in the histogram. The
            green dashed line represents the mean value of the histogram. The green shaded area represents +/- one RMS.
        </p>
        <p>
        ...
        <p>
            Different scaling functions and color maps can be chosen via the <code>Scaling</code> and <code>Color map</code> dropdown menus, respectively. A color map may be inverted via the <code>Invert color map</code> toggle.
        </p>
        <p>
