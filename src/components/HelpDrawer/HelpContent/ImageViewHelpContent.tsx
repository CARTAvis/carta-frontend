...
export const IMAGE_VIEW_HELP_CONTENT = (
    <div>
        ...
        <p>
            Panning is achieved by <code>drag-end-drop</code> as default. This default can be changed via the preferences dialog (<strong>File</strong> -&gt; <strong>Preferences</strong> -&gt; <strong>Global</strong>). The alternative mode
            is <code>click</code>, which causes the clicked pixel to be centered in the image viewer.
        </p>
