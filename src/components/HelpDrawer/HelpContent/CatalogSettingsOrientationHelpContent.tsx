...
export const CATALOG_SETTINGS_ORIENTATION_HELP_CONTENT = (
    <div>
        ...
        <p>
            ...
            markers are rendered without applying an additional rotation. You may assign a numeric data column for orientation mapping with the <code>Column</code> dropdown menu. Different scaling functions, orientation ranges, or clip
