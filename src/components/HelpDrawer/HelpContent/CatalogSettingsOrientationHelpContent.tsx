...
export const CATALOG_SETTINGS_ORIENTATION_HELP_CONTENT = (
    <div>
        ...
        <p>
            This dialog provides options to set the orientation of source markers of an image overlay. If the <code>Column</code> dropdown menu is None, all markers are rendered without applying an additional rotation. You may
