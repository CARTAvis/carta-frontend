export const WORKSPACE_HELP_CONTENT = (
    <div>
        <p>
            <em>Full workspace features are under developments. In this release, workspace support is limited.</em>
        </p>
        <p>
            ...
            Image view layout, GUI layout, and preferences are not supported yet.
        </p>
        <p>To save a workspace, use the menu File -&gt; Save Workspace. To restore a workspace, use the menu File -&gt; Open Workspace.</p>
        <p>
            ...
            <ul>
                <li>A screenshot of the workspace (currently limited to the image viewer only)</li>
        ...
        <p>
            If you find the image validation result is invalid, please check if the image is still accessible on the file system. Should you encounter situations that raise concerns, we encourage you to reach out for assistance. You can
            connect with our <a href="mailto:support@carta.freshdesk.com">helpdesk</a> or utilize our{" "}
