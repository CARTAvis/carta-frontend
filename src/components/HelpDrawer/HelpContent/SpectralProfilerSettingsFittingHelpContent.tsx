export const SPECTRAL_PROFILER_SETTINGS_FITTING_HELP_CONTENT = (
    <div>
        ...
        <p>
            With the fitting tab, you can fit the observed spectrum with a model profile with multiple Gaussians. Please ensure that there is only one spectral profile in the plot. Fitting multiple observed spectra is not supported. The
            supported profile functions are:
        </p>
        <ul>
            <li>Gaussian</li>
            <li>Lorentzian</li>
