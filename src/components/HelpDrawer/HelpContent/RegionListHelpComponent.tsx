    ...
    public render() {
        return (
            <div>
                ...
                <p>Region list widget provides users a list of regions created via the graphical user interface and/or via region import (<strong>File</strong> -&gt; <strong>Import regions</strong>). Basic information of a region is shown as
                    an entry in the list. The current active region is highlighted in the list and region control points are shown in the image viewer. To unselect a region, press <code>esc</code> key.</p>
