    ...
    public render() {
        return (
            <div>
                ...
                <p>The <code>lock</code> button for each region entry is to prevent editing a region accidentally. Locked regions will appear slightly dimmer in the image viewer. The <code>center</code> button is to center a region in the
