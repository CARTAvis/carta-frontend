        ...
        return (
            <Drawer {...drawerProps}>
                <div className={Classes.DRAWER_BODY}>
                    <iframe src={(helpStore.type !== undefined ? HELP_CONTENT_MAP.get(helpStore.type) : "") ?? ""} loading="eager" allow="camera 'none'; microphone 'none'; geolocation 'none'" title={helpStore.type ?? ""}></iframe>
                </div>
            </Drawer>
        );
    }
