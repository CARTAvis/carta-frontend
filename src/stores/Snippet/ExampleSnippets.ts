export const EXAMPLE_SNIPPETS: {name: string; section?: string; code: string}[] = [
    {
        name: "01. Quick start",
        section: "Tutorial",
        code: `// 01. Quick start
...
// The active image can be changed with "updateActiveImageByFrame", as well as the wrapper
