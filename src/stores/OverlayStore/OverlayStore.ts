    ...
    public styleString(frame?: FrameStore) {
        ...
        if (!AppStore.Instance.overlaySettings.labels?.hasCustomText && labelFrameSet) {
            ...
            const getSystemName = (symbolXY: string, isSysPixel: boolean, hasUnit: boolean, explicitSystem: SystemType) => {
                ...
                } else if ((symbolXY === "RA" || symbolXY === "Dec") && AppStore.Instance.overlaySettings.labels?.isRaDecReference) {
...
export class OverlayTitleSettings {
    ...
    @computed get styleString() {
        const astString = new ASTSettingsString();
        astString.add("DrawTitle", this.isShow);
    ...
    @action setCustomText = (isCustomTitle: boolean) => {
        this.hasCustomText = isCustomTitle;
    };
}
...
export class OverlayNumberSettings {
    ...
    @computed get styleString() {
        ...
        astString.add("NumLab", this.isShow);
...
export class OverlayLabelSettings {
    ...
    @observable isRaDecReference: boolean = true;
    @observable hasCustomText: boolean = false;
    ...
    @computed get styleString() {
        ...
        astString.add("TextLab", this.isShow);
    ...
    @action setRaDecReference(isRaDecReference: boolean) {
...
export class OverlayColorbarSettings {
    ...
    @action setBorderVisible = (isVisible: boolean) => {
    ...
    @action setBorderCustomColor = (hasCustomColor: boolean) => {
        this.hasBorderCustomColor = hasCustomColor;
    };
    ...
    @action setTickVisible = (isVisible: boolean) => {
        this.isTickVisible = isVisible;
    };
    ...
    @action setTickCustomColor = (hasCustomColor: boolean) => {
        this.hasTickCustomColor = hasCustomColor;
    };
    ...
    @action setNumberVisible = (isVisible: boolean) => {
        this.isNumberVisible = isVisible;
    };
    ...
    @action setNumberCustomPrecision = (hasCustomPrecision: boolean) => {
        this.hasNumberCustomPrecision = hasCustomPrecision;
    };
    ...
    @action setNumberCustomColor = (hasCustomColor: boolean) => {
        this.hasNumberCustomColor = hasCustomColor;
    };
    ...
    @action setLabelVisible = (isVisible: boolean) => {
    ...
    @action setLabelCustomText = (hasCustomText: boolean) => {
        this.hasLabelCustomText = hasCustomText;
    };

    @action setLabelCustomColor = (hasCustomColor: boolean) => {
        this.hasLabelCustomColor = hasCustomColor;
    };
    ...
    @action setGradientVisible = (isVisible: boolean) => {
        this.isGradientVisible = isVisible;
    };
...
export class OverlaySettings {
    ...
    @action toggleLabels = () => {
        const isNewState = !this.isLabelsHidden;

        this.labels.setHidden(isNewState);
        this.numbers.setHidden(isNewState);
        this.title.setHidden(isNewState);
    };
    ...
    @computed get shouldShowNumbers() {
        return this.numbers.isShow && this.global.labelType === LabelType.Exterior;
    }
    ...
    @computed get labelWidth(): number {
        return this.labels.isShow ? this.defaultGap + this.labels.fontSize : 0;
    }

    @computed get colorbarHoverInfoHeight(): number {
        return !this.colorbar.isVisible || (this.colorbar.isVisible && this.colorbar.position !== "bottom" && this.labels.isShow) || (this.colorbar.isVisible && this.colorbar.position === "bottom" && this.colorbar.isLabelVisible) ? 0 : 10;
    }
    ...
    @computed get paddingTop(): number {
        return this.base + (this.title.isShow ? this.titleGap + this.title.fontSize : this.colorbar.isVisible && this.colorbar.position === "top" ? this.colorbar.totalWidth : 0);
    }
