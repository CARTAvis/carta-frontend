...
export class RenderConfigStore {
    ...
    constructor(readonly preference: PreferenceStore, frame: FrameStore) {
        ...
        this.selectedPercentile = new Array(18).fill(percentile); // [percentile, percentile, percentile, percentile]
        this.bias = 0;
        this.contrast = 1;
        ...
        this.stokes = 0;
        this.scaleMin = new Array(18).fill(0); // [0, 0, 0, 0]
        this.scaleMax = new Array(18).fill(1); // [1, 1, 1, 1]
        this.visible = true;
    }
