...
import {IntensityUnitType, LineSettings, MultiProfileCategory, PlotType, POLARIZATIONS, RegionId, RegionsType, SmoothingType, SpectralProfilerSettingsTabs, SpectralSystem, TelemetryAction} from "enums";
