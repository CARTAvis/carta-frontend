...
export class Render3DWidgetStore extends RegionWidgetStore {
    ...
    public static CalculateRequirementsMap(widgetsMap: Map<string, Render3DWidgetStore>) {
        ...
        widgetsMap.forEach(widgetStore => {
            ...
            if (region && !region.isAnnotation) {
                ...
                if (existingConfig) {
                    ...
                    regionRequirements.spatialProfiles.push(Render3DWidgetStore.GetSpatialConfig(frame, widgetStore.fullCoordinate, region, region.lineRegionSampleWidth));
                }
            }
        });
