...
export class Render3DWidgetStore extends RegionWidgetStore {
    ...
    // this is used to create the styling panel in setting (e.g. histogram settings).
    ...
    // this is used to create the styling panel in setting (e.g. histogram settings). must add widgetstore in WidgetStore.ts, search for "toConfig"
    // public toConfig = () => {
    //     return {
