...
export type ControlHeader = {columnIndex: number | undefined; dataIndex: number | undefined; isDisplay: boolean | undefined; filter: string; columnWidth: number | null | undefined};
...
export class CatalogProfileStore extends AbstractCatalogProfileStore {
    ...
    @computed get shouldLoadOntoImage() {
    ...
    @computed get columnIndices(): Array<number> {
        ...
        this.catalogControlHeader.forEach((value, key) => {
            if (value.isDisplay && value.columnIndex !== undefined) {
