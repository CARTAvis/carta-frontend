...
export class RenderConfigStore {
    ...
    @observable shouldUseCubeHistogram: boolean = false;
    @observable shouldUseCubeHistogramContours: boolean = false;
    ...
    @computed get histogram() {
        if (this.shouldUseCubeHistogram && this.cubeHistogram) {
    ...
    @computed get contourHistogram() {
        if (this.shouldUseCubeHistogramContours && this.cubeHistogram) {
            return this.cubeHistogram;
        } else {
            return this.channelHistogram;
        }
    ...
    @action updateChannelHistogram = (histogram: CARTA.IHistogram) => {
        ...
        if (this.selectedPercentile[this.stokesIndex] > 0 && !this.shouldUseCubeHistogram) {
            this.setPercentileRank(this.selectedPercentile[this.stokesIndex]);
        }
    };
    ...
    @action updateFromWorkspace = (config: WorkspaceRenderConfig) => {
        ...
        this.shouldUseCubeHistogram = false;
        this.shouldUseCubeHistogramContours = false;
        this.updateSiblings();
    };
}
