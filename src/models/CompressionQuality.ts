export class CompressionQuality {
    ...
    public static isImageCompressionQualityValid = (value: number): boolean => {
        return isFinite(value) && value >= CompressionQuality.IMAGE_MIN && value <= CompressionQuality.IMAGE_MAX ? true : false;
    };

    public static isAnimationCompressionQualityValid = (value: number): boolean => {
        return isFinite(value) && value >= CompressionQuality.ANIMATION_MIN && value <= CompressionQuality.ANIMATION_MAX ? true : false;
    };
}