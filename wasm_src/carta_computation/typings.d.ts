...
export const CalculateCatalogSize: (data: Array<number>, min: number, max: number, sizeMin: number, sizeMax: number, scaling: number, area: boolean, alpha?: number, gamma?: number) => Float32Array;
export const CalculateCatalogColor: (data: Array<number>, invert: boolean, min: number, max: number, scaling: number, alpha?: number, gamma?: number) => Float32Array; 