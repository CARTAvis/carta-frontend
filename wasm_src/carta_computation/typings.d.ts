...
export const CalculateCatalogSize: (data: Float32Array, min: number, max: number, sizeMin: number, sizeMax: number, scaling: number, mapType: number, devicePixelRatio: number, alpha?: number, gamma?: number) => Float32Array;
