...
export const CalculateCatalogSize: (data: Array<number>, min: number, max: number, sizeMin: number, sizeMax: number, scaling: number, sizeType: string, alpha?: number, gamma?: number) => Float32Array;
