...
emcc -o build/carta_computation.js carta_computation.cc Point2D.cc ../../wasm_libs/zstd/build/standalone_zstd.bc \
  ...
  -s NO_EXIT_RUNTIME=1 -s EXPORTED_FUNCTIONS='["_ZSTD_decompress", "_decodeArray", "_generateVertexData", "_calculateCatalogSizeDiameter", "_calculateCatalogSizeArea", "_calculateCatalogColorMap", "_calculateCatalogOrientationMap","_malloc", "_free"]' \
