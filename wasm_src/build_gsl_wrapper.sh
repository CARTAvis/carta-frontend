...
emcc -o build/gsl_wrapper.js gsl_wrapper.cc --pre-js build/pre.js --post-js build/post.js -I ../../wasm_libs/gsl/build/include \
    -L../../wasm_libs/gsl/build/lib -lm -lgsl -lm -lgslcblas -g0 -O2 -std=c++11 \
