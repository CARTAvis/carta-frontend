...
// Module.initSpectralFrame = Module.cwrap("initSpectralFrame", "number", ["string"]);
Module.initSpectralFrame = Module.cwrap("initSpectralFrame", "number", ["string", "string", "string", "string", "string", "string", "string", "string", "string"]);
