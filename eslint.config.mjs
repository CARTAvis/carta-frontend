...
export default [
    {
        ignores: ["node_modules/**", "wasm_src/**", "docs_website/**", "protobuf/**", "src/components/**", "src/icons/**", "src/scripting/**", "src/utilities/**", "src/services/**", "src/models/**", "src/enums/**", "src/stores/DialogStore/**", "src/stores/FileBrowserStore/**", "src/stores/Frame/**", "src/stores/ImageViewConfig/**", "src/stores/OverlayStore/**", "src/stores/SpatialProfileStore/**", "src/stores/SpectralProfileStore/**", "src/stores/Widgets/**", "src/stores/PreferenceStore/**"]
    },
    {
        files: ["**/*.js", "**/*.jsx", "**/*.ts", "**/*.tsx"],
        languageOptions: {
