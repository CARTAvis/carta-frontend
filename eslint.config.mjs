...
export default [
    {
        ignores: ["node_modules/**", "wasm_src/**", "docs_website/**", "protobuf/**", "src/components/**", "src/icons/**", "src/scripting/**", "src/utilities/**", "src/services/**", "src/models/**", "src/enums/**", "src/stores/Frame/**", "src/stores/Widgets/WidgetsStore.ts", "src/stores/Widgets/EmptyWidgetStore.ts", "src/stores/Widgets/CatalogWidget/**", "src/stores/Widgets/HistogramWidgetStore/**", "src/stores/Widgets/LayerListWidgetStore/**", "src/stores/Widgets/PvGeneratorWidgetStore/**", "src/stores/Widgets/RegionWidgetStore/**", "src/stores/Widgets/RenderConfigWidgetStore/**", "src/stores/Widgets/SpatialProfileWidgetStore/**", "src/stores/Widgets/SpectralLineQueryWidgetStore/**", "src/stores/Widgets/SpectralProfileWidget/**", "src/stores/Widgets/StatsWidgetStore/**"]
    },
    {
        files: ["**/*.js", "**/*.jsx", "**/*.ts", "**/*.tsx"],
        languageOptions: {
