...
<ApiLink path="/.-stores/class/FrameStore/#setStokes">`setStokes`</ApiLink> and <ApiLink path="/.-stores/class/FrameStore/#setStokesByIndex">`setStokesByIndex`</ApiLink> change the stokes of the image using
<ApiLink path="/.-models/enum/POLARIZATIONS">`POLARIZATIONS`</ApiLink> enum or the index.
...
<ApiLink path="/.-stores/class/RenderConfigStore/#setColorMap">`setColorMap`</ApiLink> changes the color map using options in <ApiLink path="/.-stores/class/RenderConfigStore/#COLOR_MAPS_ALL">`COLOR_MAPS_ALL`</ApiLink> list, and
<ApiLink path="/.-stores/class/RenderConfigStore/#setInverted">`setInverted`</ApiLink> inverts the color map.
