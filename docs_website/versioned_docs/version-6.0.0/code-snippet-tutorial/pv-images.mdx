...
The configuration for the generator is accessible via <ApiLink path="/6.0.0/stores/class/PvGeneratorWidgetStore">`PvGeneratorWidgetStore`</ApiLink>. Example code:
