...
<ApiLink path="/stores/class/RenderConfigStore/#setColorMap">`setColorMap`</ApiLink> changes the color map using options in <ApiLink path="/utilities#COLOR_MAPS_ALL">`COLOR_MAPS_ALL`</ApiLink> list, and
