...
The configuration for the generator is accessible via <ApiLink path="/5.1.0/stores/class/PvGeneratorWidgetStore">`PvGeneratorWidgetStore`</ApiLink>. Example code:
